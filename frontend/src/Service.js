    ...
    <div className="service component__space" id="Services">
      <div className="heading">
        ...
        <p className="heading p__color">
          I am thrilled to introduce you to my web development services.
        </p>
        <p className="heading p__color">
          we specialize in designing and developing custom websites that are
          tailored to meet the unique needs and goals of our clients.
        </p>
      </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">
                  I'm passionate about website development.
                </p>
                <p className="p service__text p__color">
                  I believe that a well-designed and well-developed website is
                  crucial for any business or organization that wants to succeed
